...
* ockovani 0..* Base "A.2.3.1 - Očkování" """Seznam provedených očkování"""
  ...
  * ockovaciLatka 0..1 string "A.2.3.1.4 - Očkovací látka" """Registrovaný název podané vakcíny dle databáze léčivých přípravků (DLP) SÚKL."""
  * drzitelRozhodnuti 0..1 Base "A.2.3.1.5 - Držitel rozhodnutí" """Výrobce vakcíny či držitel rozhodnutí o registraci""" 
  * poradoveCisloDavky 0..1 string "A.2.3.1.6 - Pořadové číslo dávky" """Pořadové číslo dávky""" 
...
* historieZdravotnichProblemu 0..* Base "A.2.3.2 - Historie zdravotních problémů" """Seznam významných zdravotních problémů, které pacient prodělal v minulosti a které mohou mít vliv na jeho současný zdravotní stav"""
  ...
  * stadiumOnemocneni 0..1 Base "A.2.3.2.8 - Stadium onemocnění" """Stadium/grading problému dle zvolené škály textem a/nebo kódem"""
