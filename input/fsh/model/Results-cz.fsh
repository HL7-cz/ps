...
Description: """Logický model pro výsledky v Pacientském souhrnu (Review)
...
* detailVysetreni 1..1 Base "A.2.8.4 Detaily vyšetření" """Detailní informace včetně kódu vyšetření, tělesné struktury nebo vzorku, data a času odběru""" //TODO: co zvolit za strukturu, nebo ještě rozělit na položky?
* vysledkyVysetreni 0..1 Base "A.2.8.5 Výsledky vyšetření" """Výsledek vyšetření – číselný nebo kódovaný, včetně způsobu měření, referenčních hodnot a interpretace""" //TODO: co zvolit za strukturu, nebo ještě rozělit na položky?
