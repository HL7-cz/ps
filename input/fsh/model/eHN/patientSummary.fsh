...
* header.subject 1..1 Subject "A.1.1 A1.2 Patient/subject" """A.1.1 Identification of the patient/subject and A.1.2 Patient/subject related contact information  """				
...
* body.alerts.allergy 0..* Allergy "A.2.1.1 Allergy" """A.2.1.1 - Allergy"""				
...
* body.medicalHistory.vaccination 0..* Vaccination "A.2.2.1 Vaccination/ prophylaxis information" """A.2.2.1 - Vaccination/ prophylaxis information"""				
* body.medicalHistory.inactiveProblem 0..* ClosedProblem "A.2.2.2 Resolved, closed or inactive problems" """A.2.2.2 - Resolved, closed or inactive problems"""				
...
* body.medicalProblems.problems 0..1 Problem "A.2.3.1 Current problems" """A.2.3.1 Current problems"""				
...
* body.results 0..1 Result "A.2.8 Results" """A.2.8 - Results"""				
